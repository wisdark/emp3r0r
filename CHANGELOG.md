...
## [1.24.0](https://github.com/wisdark/emp3r0r/compare/v1.23.4...v1.24.0) (2023-02-23)
...
* add cowsay ([74be24c](https://github.com/wisdark/emp3r0r/commit/74be24c25af23814df0ccbe2b35f81480cc8d18d))
* Add cross-platform support ([666051d](https://github.com/wisdark/emp3r0r/commit/666051dca08804b25ecdd217a003aa72890b8871))
* add KCP C2 transport ([d33c9a1](https://github.com/wisdark/emp3r0r/commit/d33c9a102424067f90eee6a9fb79972df3c0ef71))
* add KCP transport, C2 traffic in obfuscated and fast UDP ([024543e](https://github.com/wisdark/emp3r0r/commit/024543efd03884343560c475990ad07f5743d208))
* add shadowsocks ([a8117e9](https://github.com/wisdark/emp3r0r/commit/a8117e97a6c818b9c548bc474027cc47dd24b708))
* Add Shadowsocks obfuscator to C2 transport ([73a4d67](https://github.com/wisdark/emp3r0r/commit/73a4d6782712388e3ee76b9babcfa3b6dc314f30))
* add verification to handshake process ([6a9fc04](https://github.com/wisdark/emp3r0r/commit/6a9fc0404c562c547e6676e95e2d8ec5a483279b))
...
* build system redesigned ([38cfd9f](https://github.com/wisdark/emp3r0r/commit/38cfd9ff7c26a87773b72b0e3a6e1615177520d6))
* build.py now generates stub.exe ([3dd2009](https://github.com/wisdark/emp3r0r/commit/3dd2009bd8cb2e9d4eb5fda056e65883b9aede22))
* change build process ([a5fc6eb](https://github.com/wisdark/emp3r0r/commit/a5fc6ebdd39b846eaefcb4172baff2fc202241ae))
* check if agent is started by ELF loader by PATH hash ([2df3c1d](https://github.com/wisdark/emp3r0r/commit/2df3c1d827f5634bc25f2ae9f116bfdfa99e88a4))
* cmd handler is blocking most commands ([c500a6e](https://github.com/wisdark/emp3r0r/commit/c500a6efbd1feaec5c9441dd498db24d32c07584))
...
* do not pack agent binaries ([d65e675](https://github.com/wisdark/emp3r0r/commit/d65e675d226226c497bc8c6b367a034b6332348c))
* emp3r0r installer ([f126780](https://github.com/wisdark/emp3r0r/commit/f12678038a53e12862865b17048e2e7ba69b4ba0))
* enable logging for shadowsocks server when debug level is set to `3` ([4d79ea9](https://github.com/wisdark/emp3r0r/commit/4d79ea9e52b0debdbc7aee6347eb2c4603b3d8b3))
...
* generate agent id from host config ([1bf31c2](https://github.com/wisdark/emp3r0r/commit/1bf31c2c65e26caf1242ebaf76f2b52eaf3e6e47))
* implement build.py in CC ([4d237b0](https://github.com/wisdark/emp3r0r/commit/4d237b058c37ec97c390530609bf5c55642b0a07))
* improve agent binary structure ([fd76e5c](https://github.com/wisdark/emp3r0r/commit/fd76e5cd3bb8efcd2b017ca24ada5d432e070b0c))
* improved C2 launcher, auto-build working ([b33aa19](https://github.com/wisdark/emp3r0r/commit/b33aa19a05b74ee8a43980ea741c3d953f98cfa0))
* install emp3r0r to your system, load custom modules from ~/.emp3r0r ([77f1564](https://github.com/wisdark/emp3r0r/commit/77f1564d9dd556271efb726272278121ad3cd747))
* integrate packer into C2 ([c81cd7d](https://github.com/wisdark/emp3r0r/commit/c81cd7dd1e69042fb2fe78964eae3c4884ae6542))
...
* randomize heartbeat payload length ([920d01d](https://github.com/wisdark/emp3r0r/commit/920d01dfe3fbb77edf8245c4b8d88624178b8d52))
* recognize more linux distros, and get vendor name ([5f4df0d](https://github.com/wisdark/emp3r0r/commit/5f4df0d3c5771bd902edac316150060e92d23236))
* reduce and randomize C2 heart-beat traffic, may cause longer wait time in agent state checking ([dee4b30](https://github.com/wisdark/emp3r0r/commit/dee4b30e4bd696b46c044386d219040715ad35ad))
* remove agent on command exec timeout ([97eacdb](https://github.com/wisdark/emp3r0r/commit/97eacdbf7841b314062fbcb6148463b1018ff1bd))
* remove windows support ([3a9660e](https://github.com/wisdark/emp3r0r/commit/3a9660e72870c594cf1390c9e7513fa749de00ba))
* rename outfile ([5512998](https://github.com/wisdark/emp3r0r/commit/55129983ed5f56137d5d6bf5eed2bb2b0be9844e))
...
* use colored print for all fatal errors ([9933d86](https://github.com/wisdark/emp3r0r/commit/9933d8635318757ca8d4e477fc3ea66cc013ec8b))
* use upx to further compress packed agent binaries ([1c6800f](https://github.com/wisdark/emp3r0r/commit/1c6800ff4a3162c8e64f72f28b78f2582f0e2db7))


### Bug Fixes

* 'unknown_host' in agent tag ([1aa8eb4](https://github.com/wisdark/emp3r0r/commit/1aa8eb47aa01f0a9a6322d82318e8fb4fd64fec2))
* [#105](https://github.com/wisdark/emp3r0r/issues/105) ([32d88f7](https://github.com/wisdark/emp3r0r/commit/32d88f72b7b400959e41031414370baa0beba42e))
* [#105](https://github.com/wisdark/emp3r0r/issues/105), show C2 names in cowsay ([d76e7cb](https://github.com/wisdark/emp3r0r/commit/d76e7cb6c33de6c4cda989ec516ac2dde919aac5))
* [#118](https://github.com/wisdark/emp3r0r/issues/118) implement a 2min timeout in C&C tun ([2ecccf6](https://github.com/wisdark/emp3r0r/commit/2ecccf60db1966fe83e8c5006618da02b4b20356))
* [#122](https://github.com/wisdark/emp3r0r/issues/122) partially fix, shell window in main tmux pane now works ([17141b8](https://github.com/wisdark/emp3r0r/commit/17141b84c46f4986c7baf8fee9213d8478d1f6d0))
* [#122](https://github.com/wisdark/emp3r0r/issues/122) title bar height not considered ([98cc556](https://github.com/wisdark/emp3r0r/commit/98cc5562c373ce144a3dbf445af7ee0c28567811))
* [#122](https://github.com/wisdark/emp3r0r/issues/122) window resizing now works mostly ([bb1af5d](https://github.com/wisdark/emp3r0r/commit/bb1af5d694c685982190c24bd6b9351c482c62fa))
...
* [#89](https://github.com/wisdark/emp3r0r/issues/89) ([1e1b838](https://github.com/wisdark/emp3r0r/commit/1e1b8380c89effbbdf7d5686147b6666dd1eddfc))
* [#94](https://github.com/wisdark/emp3r0r/issues/94) windows support now complete ([d7b812d](https://github.com/wisdark/emp3r0r/commit/d7b812df0a5a77aec24c58df99f6b3bf925c8b2b))
* `cc_indicator` option not covered by `gen_agent` ([374ad67](https://github.com/wisdark/emp3r0r/commit/374ad67677d0d50fb368754e0513d11916c944b4))
* `emp3r0r --release` cannot build agent stub ([a277515](https://github.com/wisdark/emp3r0r/commit/a277515557c8c1fab3ecd7a971cff71a1981bf1d))
* `emp3r0r --release` fails to build packer_stub ([5dd8f99](https://github.com/wisdark/emp3r0r/commit/5dd8f997e249abd84b7128760731ae72e0f42131))
* `garble -tiny build` in build script ([b643875](https://github.com/wisdark/emp3r0r/commit/b6438756aa6a7433b703c787593504661b6b8175))
* `garble -tiny` now works ([3c1b9b3](https://github.com/wisdark/emp3r0r/commit/3c1b9b32e1fa4476f7ed6a047689f3c47482879b))
* `interactive_shell` for Windows: fails to find shell process sometimes ([bf1883d](https://github.com/wisdark/emp3r0r/commit/bf1883d17bfb133d73870f3d6e7fdcd8c75a24e4))
* `interactive_shell` for Windows: too many callback functions ([1f0155b](https://github.com/wisdark/emp3r0r/commit/1f0155b34715bcf6ce04206dc18699d4e04e429e))
* 149 ([04188f7](https://github.com/wisdark/emp3r0r/commit/04188f7dc4ecad0d84149b5de92165628c024199))
* abort when CA is not added ([3edca43](https://github.com/wisdark/emp3r0r/commit/3edca43d8d18765dec794f5e5d4368475963d4fd))
* address [#45](https://github.com/wisdark/emp3r0r/issues/45), do not start socks5 proxy unless told to ([e9deb8e](https://github.com/wisdark/emp3r0r/commit/e9deb8e402dbc5147b3d89eda8d31333d65d5756))
* agent does not connect immediately after checking in ([afa4bff](https://github.com/wisdark/emp3r0r/commit/afa4bff4b54807a991c6d364b1384a6d6cdf54bf))
...
* agent not reconnecting immediately after losing connection ([59eaa1f](https://github.com/wisdark/emp3r0r/commit/59eaa1ff6b64f4d07fc84db31a468276ba833102))
* agent re-connection takes too long ([4febec6](https://github.com/wisdark/emp3r0r/commit/4febec6c7add168919f957cb7808df7c04ac2f10))
* alert user only when the agent is connected correctly ([44ee708](https://github.com/wisdark/emp3r0r/commit/44ee7086340d4c8d36d0be2b6ec28bcfb3bbb705))
* binaries not added in archive ([7383bd7](https://github.com/wisdark/emp3r0r/commit/7383bd71b5f82606f58ccbe476335b4f66ebe9cd))
* branch name ([3ee4f80](https://github.com/wisdark/emp3r0r/commit/3ee4f8099da1ffcefe35a6ef95ae98d3e824674f))
...
* build --clean success message ([6eebb2b](https://github.com/wisdark/emp3r0r/commit/6eebb2b78d84cd7632fca6a120eceb7979b112ac))
* build script typo, archive structure ([ced5651](https://github.com/wisdark/emp3r0r/commit/ced56510e4bd82e94894f276c247b345a07150ce))
* build.py --target clean deletes everything ([6842acc](https://github.com/wisdark/emp3r0r/commit/6842accd8cc7ab9e9324243b0f98e8c042ac0483))
* build.py: sed should tell us what's being updated ([4bb2894](https://github.com/wisdark/emp3r0r/commit/4bb2894e58b10addba29e5356390b5f6f7ba8866))
* C2 prints the wrong version string ([a59e18c](https://github.com/wisdark/emp3r0r/commit/a59e18c2abef429d98bd886d325023c972c069e2))
* CA cert missing ([b1885b9](https://github.com/wisdark/emp3r0r/commit/b1885b9e81a40fe3072caf15ddd17fb59da35547))
* ca key file name ([5547eed](https://github.com/wisdark/emp3r0r/commit/5547eeddf1f326242e4483c1a632acf831eb5b79))
* cannot pack custom modules due to incorrect path ([c535350](https://github.com/wisdark/emp3r0r/commit/c535350a52f4d6906d8fe1473398636ccd983fd1))
* cannot set target ([7473bd3](https://github.com/wisdark/emp3r0r/commit/7473bd37abcedcd3fb486fbffb4f54b06a67762d))
* catch errors when using gen_agent ([699ebf2](https://github.com/wisdark/emp3r0r/commit/699ebf233e6bd1bccc0067a7795e03278a5f09a1))
* clear changlog ([88b425a](https://github.com/wisdark/emp3r0r/commit/88b425a69240d708cf6458141a1c0cb52ee565d8))
* CliAsk: ignore ctrl-c and EOF ([85180af](https://github.com/wisdark/emp3r0r/commit/85180af56a61b8706eee8f0f7612572f0393051b))
* command pane remains after exiting emp3r0r ([ed3cf1c](https://github.com/wisdark/emp3r0r/commit/ed3cf1cec5220bec3f7f9f61f86816323148c356))
...
* ConnectCC stucks when using KCP ([58d5f89](https://github.com/wisdark/emp3r0r/commit/58d5f89aa0506c95f1d29824046979ab2026393b))
* ConnectCC timeout not implemented correctly ([d58ac5e](https://github.com/wisdark/emp3r0r/commit/d58ac5eaed680ab591091f920a39d801cba1b090))
* curl cmd in workflow file ([db91dd2](https://github.com/wisdark/emp3r0r/commit/db91dd272657a35ccda0f53268f188f60d8e80da))
* curl upload asset ([058a637](https://github.com/wisdark/emp3r0r/commit/058a6370aa9a28374342dd9d7c7e0c9de80c2cb4))
* curl upload asset ([876935e](https://github.com/wisdark/emp3r0r/commit/876935e6336d5b2821aaf2381ae0fd68ce5376ce))
* default shell should be static bash ([e789658](https://github.com/wisdark/emp3r0r/commit/e789658621a09c47a0e938a0cc0912866e9cc550))
* deprecate release.py ([fe30602](https://github.com/wisdark/emp3r0r/commit/fe30602638c6c138253069d68dc4edbaa72bf3d7))
* disable CGO to build static binaries ([f12190f](https://github.com/wisdark/emp3r0r/commit/f12190f31ab4791f2029a05b9de6c6075c730fdd))
* disallow empty input ([2c3c76d](https://github.com/wisdark/emp3r0r/commit/2c3c76da6bd711de28cd1defb890cd444492a536))
...
* emp3r0r launcher/installer path error ([e4e7a91](https://github.com/wisdark/emp3r0r/commit/e4e7a91e931ede594aaaaac8320b189546b8ac2d))
* emp3r0r.json initialization not complete ([6369379](https://github.com/wisdark/emp3r0r/commit/6369379271a15f014a5bb6481a4020a54d86293b))
* emp3r0r.json: socket name ([f6c42a9](https://github.com/wisdark/emp3r0r/commit/f6c42a99236e0c69a632e69f8b94c328bc39f345))
* empty agent uuid ([416aadc](https://github.com/wisdark/emp3r0r/commit/416aadcec61ada4f1dbf2020ad2f78afcfd04fdd))
* empty envv when started from memfd_exec ([f6a6b7d](https://github.com/wisdark/emp3r0r/commit/f6a6b7dfea7f4e09f2b6f136d018c0fe97529072))
...
* file paths ([284f161](https://github.com/wisdark/emp3r0r/commit/284f161cafe374c1c1d6ec79a287c2b9da30e733))
* filename autocompletion for packer ([1a9d180](https://github.com/wisdark/emp3r0r/commit/1a9d180e95b83a52d3007880b0d987803b9208be))
* gen_agent command ([3121a59](https://github.com/wisdark/emp3r0r/commit/3121a59862d8b16824b2229be1392449f9c56dbe))
* gen_agent: binaries not found ([31b68d1](https://github.com/wisdark/emp3r0r/commit/31b68d13fd0e7d620d920ff46a466692462f6f01))
* gen_agent: build stub.exe first ([ae01a32](https://github.com/wisdark/emp3r0r/commit/ae01a322bb5e0e40a8b8af9aa31e9964903f6b9e))
* go get -u ([8c90301](https://github.com/wisdark/emp3r0r/commit/8c903010692512a0c9d740d9cc4436428ba5b90d))
* init emp3r0r.json when it's not found ([1aed32c](https://github.com/wisdark/emp3r0r/commit/1aed32c897f0783c2c878b6f28112a8cbd860458))
* KCPClient crash ([f5202ef](https://github.com/wisdark/emp3r0r/commit/f5202ef5c6d70279c096cf4a5be55af12c9f2782))
* KCPClient not aware of C2 disconnection ([58a63a2](https://github.com/wisdark/emp3r0r/commit/58a63a22d70877f3aee0ea71b49e502db2245257))
* killing non-existent processes ([03fdf33](https://github.com/wisdark/emp3r0r/commit/03fdf3343b6a15b1492470e4cacb471541f9001f))
* LD_LIBRARY_PATH was mistakenly unset ([0cd3f3e](https://github.com/wisdark/emp3r0r/commit/0cd3f3ecb2f0959563151fe4d51e6556d3e222ef))
* lengthy log ([a3e2f72](https://github.com/wisdark/emp3r0r/commit/a3e2f72321febcd18529cb3861e51cbe918761d3))
* line wrapping in `CliPrettyPrint` ([f406224](https://github.com/wisdark/emp3r0r/commit/f4062247518cda72642b65558743d03d08eac395))
* line wrapping in agent list brings extra whitespaces ([3a03153](https://github.com/wisdark/emp3r0r/commit/3a03153c5f05fda718392661ae30f6c79335f6c5))
* line wrapping inside tables ([5f6b3db](https://github.com/wisdark/emp3r0r/commit/5f6b3db264dcfb93237504c35578049c0db33d81))
* logging level in checkinHandler ([ea06c68](https://github.com/wisdark/emp3r0r/commit/ea06c68084b803b2a0ae7caa444df321d93d5361))
* magic string should be pre-set ([9dd87a9](https://github.com/wisdark/emp3r0r/commit/9dd87a9f3febd0f11f86aa23102df62404e6f2b7))
...
* make packed binaries executable by default ([5d2c944](https://github.com/wisdark/emp3r0r/commit/5d2c9448adea5b8f684b8e80cc601f6f962f6b91))
* missing file in dockerscan libs ([7a49ed7](https://github.com/wisdark/emp3r0r/commit/7a49ed7a7a9b6706e06252f63b5c4abc2a439b9d))
* modules don't load ([7bac146](https://github.com/wisdark/emp3r0r/commit/7bac14606a9a4df253d210ab29a30c35bde5257c))
* need to check out repo before creating release archive ([dc3947b](https://github.com/wisdark/emp3r0r/commit/dc3947bd70103ca726ce801cb7007bb352cb1f90))
* no build option for Windows ([9c7d22d](https://github.com/wisdark/emp3r0r/commit/9c7d22deea7525e7dd888692716c7495a5c5486b))
* no need to decompress ([eb231e9](https://github.com/wisdark/emp3r0r/commit/eb231e9ef30a3f55bf0bb2994df755aff7c838f7))
* onion address checking ([628d527](https://github.com/wisdark/emp3r0r/commit/628d5275d59e2adee687c8d48ed85ec15ca24c95))
* optimize build script ([3ebbee9](https://github.com/wisdark/emp3r0r/commit/3ebbee9b64a3f4b102b3fc303c683396d5011fd0))
* pack_agent command ([7d2dcea](https://github.com/wisdark/emp3r0r/commit/7d2dcea321695a52256416a1f29e7fd672953fe4))
* packed agent cannot find config data ([e621808](https://github.com/wisdark/emp3r0r/commit/e621808bed15ea0ec4189e5c31240b9f31034a4f))
* packer blocks UI ([6788b35](https://github.com/wisdark/emp3r0r/commit/6788b351cae09dd90f6fbe14e9ef6a9cbb27ac66))
* packer should NOT exit, it should be protecting agent process ([a3f5cb1](https://github.com/wisdark/emp3r0r/commit/a3f5cb122a7ffd4740aaeb8a9c44a87a5647d0e8))
* packer_stub.exe path ([7b7a2d7](https://github.com/wisdark/emp3r0r/commit/7b7a2d7b49d86dec2948d3de18c66ff918c30c49))
* packer: pass config data and ELF through envv ([b6a0d7b](https://github.com/wisdark/emp3r0r/commit/b6a0d7b4d831497e66d46b5d36071e46fb2b6e06))
* path errors ([70d8362](https://github.com/wisdark/emp3r0r/commit/70d8362fd688d6ab629deac201578c8d27a034e7))
* PKGBUILD for blackarch ([e496738](https://github.com/wisdark/emp3r0r/commit/e4967387f66bfd605b97a8c231631a2abc95506f))
...
* print 'go build ends' after `go build` ([a73ff81](https://github.com/wisdark/emp3r0r/commit/a73ff8165d24227cf633910e4b7857614a3ee7a6))
* python path ([a437008](https://github.com/wisdark/emp3r0r/commit/a437008c6e67ffdda15c20bb719420c77502358c))
* race condition in polling ([0caba63](https://github.com/wisdark/emp3r0r/commit/0caba63155bbdd6a50d606c67c7bc65268b2395b))
* race condition in polling ([b3d4a20](https://github.com/wisdark/emp3r0r/commit/b3d4a2074d336c81903487c3a57b3446aa62284b))
* RandStr not random enough with time.Now as seed ([e3aed62](https://github.com/wisdark/emp3r0r/commit/e3aed626744c55b0488a4035ce256aa17f48e6a2))
* reduce agent binary size for windows version ([9a486f7](https://github.com/wisdark/emp3r0r/commit/9a486f7bf9a0a2647709ee36f7bba8cc5a5939d4))
* reduce packer_stub binary size ([c67fff9](https://github.com/wisdark/emp3r0r/commit/c67fff9632d2d4f6c9647828731e1e782730dd14))
* reduce size of data package ([c441325](https://github.com/wisdark/emp3r0r/commit/c441325aa23f7b166b2419049163af59a653e83f))
* release-please action ([056dd03](https://github.com/wisdark/emp3r0r/commit/056dd03acf9deb64d28c9e332b5a0b80247f769f))
* release.sh ([9b9667d](https://github.com/wisdark/emp3r0r/commit/9b9667df124bd3471c31925b6840d0b6d0f66606))
* remove binary from source tree ([c5955b8](https://github.com/wisdark/emp3r0r/commit/c5955b8b89d01c2609028c1f4464d778661adbd9))
...
* restore messed-up build-time variables ([72da2c7](https://github.com/wisdark/emp3r0r/commit/72da2c764170d177a1678ea7435a397ad38f11bf))
* restore source files when build is aborted ([07ab26c](https://github.com/wisdark/emp3r0r/commit/07ab26c86d03e64f9ab1fa08d23d0c13a19671fd))
* rm redundant build function ([cbaa7e7](https://github.com/wisdark/emp3r0r/commit/cbaa7e7a3226102ae359b012f4d2f8898ea48425))
* sanitize filename ([33f724e](https://github.com/wisdark/emp3r0r/commit/33f724eabfa3c879b4cb4f4360716825c3ef2930))
* save some time if release not created ([2dc20ef](https://github.com/wisdark/emp3r0r/commit/2dc20ef0107b64d6c718d9421771cad96a5212cd))
* screenshot downloading fails ([886e864](https://github.com/wisdark/emp3r0r/commit/886e864679bd91590e576e0b61d9288bde0cbd42))
* selected agent not visible as it's on top of the list ([48fc9a2](https://github.com/wisdark/emp3r0r/commit/48fc9a219eb4b8308e416bc6821079993d00e49e))
* set correct location for tmux scripts ([a58c1a3](https://github.com/wisdark/emp3r0r/commit/a58c1a3381d905ecf260f1b29f2705e4c2f5b8f2))
...
* should rm python archive ([68deedd](https://github.com/wisdark/emp3r0r/commit/68deedd61f9ee6ca83af8cdf1401a5a91ec85793))
* smaller tar archive ([07e6e9e](https://github.com/wisdark/emp3r0r/commit/07e6e9e046725d8e5bf876f20df084e2adcef4bf))
* some values in emp3r0r.json are not updated ([70c0f5e](https://github.com/wisdark/emp3r0r/commit/70c0f5ec7c6b0dd458b6cbdfeb4489904925bd10))
* ssh shell fails to start due to 'already bind' error ([18004a9](https://github.com/wisdark/emp3r0r/commit/18004a9e4641516d3941cde336eb8e970b9bba15))
* test a new release ([6632334](https://github.com/wisdark/emp3r0r/commit/66323346228113ae991dbe39731e380b0a6e96be))
* timeout TLS handshake, do not wait infinitely ([24dd54f](https://github.com/wisdark/emp3r0r/commit/24dd54f96a7c83f8439394eb35314154dc2ce0e3))
* tmux cat ([8d8a3c8](https://github.com/wisdark/emp3r0r/commit/8d8a3c818137aa95190910b366c96d72235e4fe3))
* tmux pane resizing issues ([7849902](https://github.com/wisdark/emp3r0r/commit/78499022d53ccdc5060e76388d49f91c2b1c76e6))
* Tmux UI outputs on wrong panes/windows ([b440c60](https://github.com/wisdark/emp3r0r/commit/b440c60a16476cdc528f7a44518545ae422d3af2))
* toggle some config options on/off ([abe600f](https://github.com/wisdark/emp3r0r/commit/abe600f0079bfa884c8f73a2585340679daacf96))
* trying to make uploading work ([fb987cc](https://github.com/wisdark/emp3r0r/commit/fb987cca5f8420e9b9949b34ef79cfbbb8f7b3ff))
* trying to upload assets ([8fb049d](https://github.com/wisdark/emp3r0r/commit/8fb049d51ba8e25a62cee13a7acdeeffee2e73e5))
* trying to use release action ([87e1437](https://github.com/wisdark/emp3r0r/commit/87e1437fedc4f5692e4e18f933962130202ab86f))
* trying to use release action ([d39ed39](https://github.com/wisdark/emp3r0r/commit/d39ed3973a24354942fb839f3801d71be52e452b))
* unable to config time intervals ([b242e80](https://github.com/wisdark/emp3r0r/commit/b242e80582d1052c663c9e37fe41b6efbbd983e9))
* unable to execute cat since `PATH` is not set ([5049837](https://github.com/wisdark/emp3r0r/commit/5049837726f009891137364cbabec3533359f7bd))
* unable to extract config data when agent is packed ([c8b5198](https://github.com/wisdark/emp3r0r/commit/c8b5198553357ba5fd8c35d159231d0e17fbbee6))
* unable to extract data from file/mem ([eff9574](https://github.com/wisdark/emp3r0r/commit/eff9574417883ec6c8b5820bb0b199acea7806bd))
* unable to extract embeded json config ([1c80ec8](https://github.com/wisdark/emp3r0r/commit/1c80ec869f6dc24fa692d89422c04ac746e970f2))
* update build.py to match build dir change ([0142126](https://github.com/wisdark/emp3r0r/commit/014212692f127d9c26dda6d73ff32d1fbdfb75ba))
* update c2 launcher ([406b1bf](https://github.com/wisdark/emp3r0r/commit/406b1bf4a7d7be7dcafe4b37004601656be62bd0))
* update go dependencies ([018b533](https://github.com/wisdark/emp3r0r/commit/018b533e55d6bfd15a2e28ca85a144adea87d42f))
* update launcher ([22b4078](https://github.com/wisdark/emp3r0r/commit/22b4078ce933ef965a1dad45c9434c03264e2492))
* upgrade deps ([441b978](https://github.com/wisdark/emp3r0r/commit/441b978d39ee40a783ee275d3028d31a34287473))
* upload assets ([c9fb994](https://github.com/wisdark/emp3r0r/commit/c9fb994b6aa995cab0f3e28f988d6efefb824ba1))
* upload assets: not found ([2d87428](https://github.com/wisdark/emp3r0r/commit/2d87428f333716c01c20988add41c52dca0d573f))
* upload-asset: file not found ([a3a6c10](https://github.com/wisdark/emp3r0r/commit/a3a6c10d6a90dd00c376b60fccd243ab9ed4aecc))
* upload.sh ([ad2315b](https://github.com/wisdark/emp3r0r/commit/ad2315b4efd58a50aa8a43cf0df8c25946f4612d))
...
* utils_path and socket name should follow agent_root ([fe514b7](https://github.com/wisdark/emp3r0r/commit/fe514b71bdff9cc6aa30b4a06f476b43f968dfd3))
* vaccine fails to configure on agent start ([c74e7fb](https://github.com/wisdark/emp3r0r/commit/c74e7fb8611f767807a8fde3a2fa73fced741c12))
* version updating ([b567907](https://github.com/wisdark/emp3r0r/commit/b567907abac5c4639f6caa22176eddc89bd5b33c))
* windows `interactive_shell` has visible console windows ([4dfd893](https://github.com/wisdark/emp3r0r/commit/4dfd8938645827d6ffdd731ffb1601dadaf6d7f9))
* windows agent cannot extract config data from exe ([add16ab](https://github.com/wisdark/emp3r0r/commit/add16abdb774414cfcf4129aedb6aaae17e73668))
* windows sysinfo ([8c7c080](https://github.com/wisdark/emp3r0r/commit/8c7c080235f54f3f6c6e5234fb54084b7d805d3b))
* workflow steps ([3a3b0bd](https://github.com/wisdark/emp3r0r/commit/3a3b0bdbc3b33efadc3a726a5422370a79edc81a))
